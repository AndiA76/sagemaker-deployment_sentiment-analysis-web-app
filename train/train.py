...
def train(model, train_loader, epochs, optimizer, loss_fn, device):
    ...
    # set hard-coded gradient clipping threshold
    ...
    for epoch in range(1, epochs + 1):
        ...
        # reset total loss to zero for each new training epoch
        total_loss = 0
        ...
        for batch in train_loader:
            ...
            # move batch of training data with labls to device
            ...
            # forward step: get the predicted sentiment label from the model
            output_y = model(batch_X)
            
            # calculate the training batch loss and perform backprop
            loss = loss_fn(output_y.squeeze(), batch_y)
            ...
            # cumulate total loss per epoch by adding the current batch loss      
            total_loss += loss.data.item()
        
        # print out average loss per epoch by dividing total loss by number of data points in training set
